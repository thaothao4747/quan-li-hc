/* QUAN LI HC - app bundle 20260720-font-icon-fix-1 */
...
if(('serviceWorker' in navigator) && location.protocol.indexOf('http')===0){window.addEventListener('load',function(){navigator.serviceWorker.register('./sw.js?v=20260720-font-icon-fix-1').catch(function(){})})}
;
...
;(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
...
;(function(){
  ...
  window.APP_VERSION=VERSION;
  function install(){
    var existing=document.getElementById('overview-total-badge-compact-style-20260720-font-icon-fix-1');
    if(existing){document.head.appendChild(existing);return}
    var st=document.createElement('style');
    st.id='overview-total-badge-compact-style-20260720-font-icon-fix-1';
...
;(function(){
  ...
  var VERSION='20260720-font-icon-fix-1',syncTimer=null,quietLocal=false;
  window.APP_VERSION=VERSION;
...
;(function(){
  ...
  var VERSION='20260720-font-icon-fix-1',timer=null,applying=false;
  window.APP_VERSION=VERSION;
  function cfg(){return window.SUPABASE_CONFIG||{}}
  function getState(){try{return typeof state!=='undefined'?state:window.state}catch(e){return window.state}}
  function apiUrl(){var c=cfg();return c.url&&c.stateId?c.url.replace(/\/$/,'')+'/rest/v1/app_state?id=eq.'+encodeURIComponent(c.stateId):''}
...
(function(){
  ...
  function installStyle(){
    if(byId('it-catalog-code-scan-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');
    st.id='it-catalog-code-scan-style-20260720-font-icon-fix-1';
...
;(function(){
  var STYLE_ID='it-catalog-hide-duplicate-title-20260720-font-icon-fix-1';
  function install(){
...
window.APP_VERSION='20260720-font-icon-fix-1';
(function(){
...
(function(){
  ...
  if(!document.getElementById('warehouse-combined-settings-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');
    st.id='warehouse-combined-settings-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('ton-search-total-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');
    st.id='ton-search-total-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('highlight-ton-search-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');
    st.id='highlight-ton-search-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(byId('ton-search-strong-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='ton-search-strong-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addPopStyle(){
    if(el('ton-search-pop-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='ton-search-pop-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(document.getElementById('ton-font-fix-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='ton-font-fix-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(document.getElementById('hide-ton-total-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='hide-ton-total-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(document.getElementById('one-font-style-20260720-font-icon-fix-1'))return;
  var st=document.createElement('style');st.id='one-font-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function byId(id){return document.getElementById(id)}
  function addStyle(){
    if(byId('scan-it-serial-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='scan-it-serial-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(document.getElementById('simple-stock-table-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='simple-stock-table-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(document.getElementById('raised-nav-buttons-style-20260720-font-icon-fix-1'))return;
  var st=document.createElement('style');st.id='raised-nav-buttons-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function byId(id){return document.getElementById(id)}
  function addStyle(){
    if(byId('direct-photo-serial-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='direct-photo-serial-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function byId(id){return document.getElementById(id)}
  function addStyle(){
    if(byId('native-photo-input-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='native-photo-input-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(document.getElementById('mobile-nav-modern-style-20260720-font-icon-fix-1'))return;
  var st=document.createElement('style');st.id='mobile-nav-modern-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(document.getElementById('stock-cards-view-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='stock-cards-view-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(document.getElementById('compact-soft-ui-style-20260720-font-icon-fix-1'))return;
  var st=document.createElement('style');st.id='compact-soft-ui-style-20260720-font-icon-fix-1';
...
(function(){
  if(document.getElementById('mobile-top-safe-style-20260720-font-icon-fix-1'))return;
  var st=document.createElement('style');
  st.id='mobile-top-safe-style-20260720-font-icon-fix-1';
...
(function(){
  if(document.getElementById('nhap-buttons-even-style-20260720-font-icon-fix-1'))return;
  var st=document.createElement('style');
  st.id='nhap-buttons-even-style-20260720-font-icon-fix-1';
...
(function(){
  if(document.getElementById('nhap-buttons-web-fix-style-20260720-font-icon-fix-1'))return;
  var st=document.createElement('style');
  st.id='nhap-buttons-web-fix-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var st=document.createElement('style');st.id='compact-search-slip-filter-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  var st=document.createElement('style');st.id='hide-report-count-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  var st=document.createElement('style');st.id='search-toolbar-compact-all-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  var st=document.createElement('style');st.id='search-input-wider-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('item-description-visible-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='item-description-visible-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('item-detail-button-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='item-detail-button-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('visual-ring-report-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='visual-ring-report-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('group-field-report-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='group-field-report-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('overview-stock-search-menu-hide-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='overview-stock-search-menu-hide-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  if(!document.getElementById('overview-search-clean-group-text-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='overview-search-clean-group-text-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('nhap-form-compact-no-dept-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='nhap-form-compact-no-dept-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('report-hide-overview-tab-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='report-hide-overview-tab-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  if(!document.getElementById('mobile-nhap-detail-fit-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='mobile-nhap-detail-fit-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  if(!document.getElementById('overview-hide-recent-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='overview-hide-recent-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  if(!document.getElementById('suggestion-soft-font-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='suggestion-soft-font-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('empty-input-placeholders-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='empty-input-placeholders-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('mobile-nav-correct-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='mobile-nav-correct-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('item-name-detail-link-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='item-name-detail-link-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  if(!document.getElementById('hide-inline-detail-label-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='hide-inline-detail-label-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('inline-clear-search-button-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='inline-clear-search-button-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  var VERSION='20260720-font-icon-fix-1';
  window.APP_VERSION=VERSION;
  if(!document.getElementById('hide-suggest-detail-button-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='hide-suggest-detail-button-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('item-photo-description-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='item-photo-description-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('import-variant-photos-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='import-variant-photos-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('hide-nhap-suggest-gap-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='hide-nhap-suggest-gap-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('hang-delete-admin-clean-detail-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='hang-delete-admin-clean-detail-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('hide-xuat-suggest-gap-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='hide-xuat-suggest-gap-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('mobile-xnk-compact-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='mobile-xnk-compact-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('warehouse-one-panel-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='warehouse-one-panel-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('employee-main-menu-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='employee-main-menu-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function ensureStyle(){
    if(byId('serial-scan-safe-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='serial-scan-safe-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(byId('xuat-employee-warehouse-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='xuat-employee-warehouse-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!document.getElementById('hide-item-detail-buttons-final-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='hide-item-detail-buttons-final-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(document.getElementById('xuat-layout-professional-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='xuat-layout-professional-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function addStyle(){
    if(document.getElementById('xuat-layout-pairs-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='xuat-layout-pairs-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!byId('report-employee-issued-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='report-employee-issued-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!byId('it-catalog-separate-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='it-catalog-separate-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!byId('it-catalog-merged-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='it-catalog-merged-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!byId('it-management-dashboard-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='it-management-dashboard-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  if(!byId('it-single-warehouse-style-20260720-font-icon-fix-1')){
    var st=document.createElement('style');st.id='it-single-warehouse-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-flow-polish-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-flow-polish-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-overview-actions-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-overview-actions-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function byId(id){return document.getElementById(id)}
  function installStyle(){
    if(byId('it-hide-summary-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-hide-summary-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-serial-onebar-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-serial-onebar-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-auto-date-warehouse-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-auto-date-warehouse-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-serial-inline-file-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-serial-inline-file-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-item-search-input-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-item-search-input-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('employee-clean-name-input-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='employee-clean-name-input-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-item-empty-on-new-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-item-empty-on-new-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-asset-list-table-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-asset-list-table-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('hide-transfer-menu-badge-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='hide-transfer-menu-badge-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-catalog-quick-card-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-catalog-quick-card-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-action-subview-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-action-subview-style-20260720-font-icon-fix-1';
    st.textContent=
...
(function(){
  ...
  function isIt(){try{return typeof current!=='undefined'&&current==='thietbi'}catch(e){return false}}
  function installStyle(){
    if(byId('it-hide-action-type-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-hide-action-type-style-20260720-font-icon-fix-1';
...
(function(){
  ...
  function installStyle(){
    if(byId('it-device-fields-style-20260720-font-icon-fix-1'))return;
    var st=document.createElement('style');st.id='it-device-fields-style-20260720-font-icon-fix-1';
